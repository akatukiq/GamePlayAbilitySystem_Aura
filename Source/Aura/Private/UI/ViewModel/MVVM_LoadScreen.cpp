...
void UMVVM_LoadScreen::NewSlotButtonPressed(int32 Slot, const FString& EnterdName)
{
	...
	LoadSlots[Slot]->SetPlayerName(EnterdName);
...
void UMVVM_LoadScreen::DeleteButtonPressed()
{
	...
	{
		AAuraGameModeBase::DeletSlot(SelectedSlot->GetLoadSlotName(), SelectedSlot->SlotIndex);
