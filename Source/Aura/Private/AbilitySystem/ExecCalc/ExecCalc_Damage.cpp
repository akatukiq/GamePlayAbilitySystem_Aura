...
void UExecCalc_Damage::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	const float EffectiveArmorConfficient = EffectiveArmorCurve->Eval(TargetPlayerLevel);
	...
	const float CriticalHitResistanceCofficient = CriticalResistanceCurve->Eval(TargetPlayerLevel);
